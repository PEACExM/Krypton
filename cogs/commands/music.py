...
#<:volume_down:1056039813712707654>
    ...
    async def volume_button(self, interaction: discord.Interaction,
        ...
        if player is None:
            hacker = discord.Embed(
                description=
                "<:error:1018174714750976030> | I am not connected to a voice channel.",
                color=0x2f3136)
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:GreenTick:1018174649198202990> | Successfully changed player volume to : `50`",
                color=0x2f3136)
            ...
            hacker2 = discord.Embed(
                description=
                f"<:error:1018174714750976030> | I am not playing anything.",
                color=0x2f3136)
    ...
    async def seek_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:GreenTick:1018174649198202990> | Seeked the current player to `10 seconds` .",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
            hacker2 = discord.Embed(
                description=
                "<:error:1018174714750976030> | I am not playing anything.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker2,
                                                           ephemeral=True)
    ...
    async def stop_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"<:GreenTick:1018174649198202990> | Destroyed the player.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    async def skip_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:GreenTick:1018174649198202990> | Successfully Skipped the track .",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    async def vol_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:GreenTick:1018174649198202990> | Successfully changed player volume to : `100`",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
...
class Music(commands.Cog):
    ...
    async def play(self, ctx: commands.Context, *, search: str):
        ...
        if not getattr(ctx.author, "voice", None):
            nv = discord.Embed(
                description=
                f'<:error:1018174714750976030> | You are not connected to a voice channel.',
                color=0x2f3136)
        ...
        if not ctx.voice_client:
            ...
            await ctx.send(
                f"<:GreenTick:1018174649198202990> | Successfully Connected To {ctx.author.voice.channel.mention}"
            )
        else:
        ...
        if 'https://open.spotify.com' in str(search):
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:jk_playing:1045213196207804568> [{track.title}](https://discord.gg/jkop)"
                )
                ...
                mbed.add_field(name="<:jk_stage:1045213415578279987> Song By",
                               value=f"`{track.author}`")
                mbed.add_field(name="<a:jk_time:1045213918320140288> Duration",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track}](https://discord.gg/jkop) Added To The Queue',
                    color=0x2f3136)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:jk_playing:1045213196207804568> [{track1}](https://discord.gg/jkop)"
                )
                ...
                embed = discord.Embed(
                    description=
                    f'[{track1}](https://discord.gg/jkop) Added To The Queue',
                    color=0x2f3136)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:jk_playing:1045213196207804568> [{track2.title}](https://discord.gg/jkop)"
                )
                ...
                embed = discord.Embed(
                    description=
                    f'[{track2}](https://discord.gg/jkop) Added To The Queue',
                    color=0x2f3136)
        ...
        if not player.queue.is_empty:
            ...
            if hasattr(new_song, 'thumb'):
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:jk_playing:1045213196207804568> [{new_song.title}](https://discord.gg/jkop)"
                )
    ...
    async def connect(self,
        ...
        if channel is None:
            ...
            av = discord.Embed(
                description=
                f"<:error:1018174714750976030> | I am already connected to a voice channel.",
                color=0x2f3136)
        ...
        sc = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully connected to {channel.mention}.",
            color=0x2f3136)
    ...
    async def leave_command(self, ctx: commands.Context):
        ...
        if ctx.author.voice is None:
            hacker = discord.Embed(
                description=
                "<:error:1018174714750976030> | You are not connected to a voice channel.",
                color=0x2f3136)
        ...
        hacker1 = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully disconnected from {ctx.author.voice.channel.mention}",
            color=0x2f3136)
    ...
    async def skip_command(self, ctx: commands.Context):
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"<:GreenTick:1018174649198202990> | Successfully Skipped the track .",
                color=0x2f3136)
    ...
    async def pause_command(self, ctx: commands.Context):
        ...
        if not player.is_paused():
            if player.is_playing():
                ...
                hacker1 = discord.Embed(
                    description=
                    f"<:GreenTick:1018174649198202990> | Successfully paused the player .",
                    color=0x2f3136)
                view = Buttons()
                await ctx.send(embed=hacker1)
            else:
            ...
            hacker3 = discord.Embed(
                description=
                f"<:error:1018174714750976030> | Player is already paused .",
                color=0x2f3136)
    ...
    async def resume_command(self, ctx: commands.Context):
        ...
        if player.is_paused():
            ...
            hacker1 = discord.Embed(
                description=
                f"<:GreenTick:1018174649198202990> | Successfully resumed the player .",
                color=0x2f3136)
            ...
            hacker3 = discord.Embed(
                description=
                f"<:error:1018174714750976030> | Player is already resumed .",
                color=0x2f3136)
    ...
    async def boost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "<:GreenTick:1018174649198202990> | Successfully enabled `bass boost` .",
            color=0x2f3136)
    ...
    async def rmvboost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "<:GreenTick:1018174649198202990> | Successfully disabled `bass boost` .",
            color=0x2f3136)
        await ctx.reply(embed=hacker4)
    ...
    async def volume(self, ctx, volume):
        ...
        if ((not volume.isdigit()) or (int(volume)) < 0
            ...
            hacker = discord.Embed(
                description=
                "<:error:1018174714750976030> | Volume Must Be 0 To 500 .",
                color=0x2f3136)
            hacker.set_footer(text=f"Requested By {ctx.author}",
                              icon_url=f"{ctx.author.avatar}")
            #hacker.set_thumbnail(url = f"{ctx.author.avatar}")
        ...
        hacker4 = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully changed player volume to : `{volume}%`",
            color=0x2f3136)
    ...
    async def playing(self, ctx):
        if not ctx.voice_client:
            hacker = discord.Embed(
                description=
                "<:error:1018174714750976030> | Not connected to a voice channel.",
                color=0x2f3136)
            hacker.set_footer(text=f"Requested By {ctx.author}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
        ...
        em = discord.Embed(
            description=f"[{vc.track}](https://discord.gg/jkop)",
            color=0x2f3136)

        em.add_field(name="<:jk_stage:1045213415578279987> Song By",
                     value=f"`{vc.track.author}`")
        em.add_field(
            name="<a:jk_time:1045213918320140288> Duration",
    ...
    async def shuffle(self, ctx):
        ...
        hacker2 = discord.Embed(
            description=
            "<:GreenTick:1018174649198202990> | Successfully shuffled the current queue .",
            color=0x2f3136)
    ...
    async def pull(self, ctx, index: int):
        ...
        if index > len(vc.queue) or index < 1:
            hacker2 = discord.Embed(
                description=
                f"<:error:1018174714750976030> | Must Be Between 1 And {len(vc.queue)} .",
                color=0x2f3136)
            return await ctx.reply(embed=hacker2)
        ...
        hacker3 = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully pulled out `{removed.title}` From Queue .",
            color=0x2f3136)
    ...
    async def _queue(self, ctx):
        if not ctx.voice_client:
            ...
            hacker1 = discord.Embed(
                description=
                "<:error:1018174714750976030> | You need to join a voice channel to play something .",
                color=0x2f3136)
            return await ctx.send(embed=hacker1)
        else:
            vc: wavelink.Player = ctx.voice_client
        ...
        if vc.queue.is_empty:
            hacker3 = discord.Embed(
                description=
                f"<:error:1018174714750976030> | No songs in queue .",
                color=0x2f3136)
        ...
        for song in copy:
            ...
            hacker4.add_field(name=f"Position : {count}",
                              value=f"[{song.title}](https://discord.gg/jkop)")
    ...
    async def _clear(self, ctx):
        ...
        hacker3 = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully Clears The current Queue .",
            color=0x2f3136)
        hacker3.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        return await ctx.send(embed=hacker3)
    ...
    async def seek_command(self, ctx, position: str):
        ...
        hacker3 = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully Seeked the current player to {secs} .",
            color=0x2f3136)
