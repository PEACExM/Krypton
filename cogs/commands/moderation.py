...
class Moderation(commands.Cog):
    ...
    async def unlockall(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:GreenTick:1029990379623292938> | Unlocking all channels in few seconds .",
    ...
    async def lockall(self, ctx, server: discord.Guild = None, *, reason=None):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:GreenTick:1029990379623292938> | Locking all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
    ...
    async def hackban(self, ctx, userid, *, reason=None):
        ...
        try:
            ...
            await ctx.reply(embed=discord.Embed(
                description=
                f"<:GreenTick:1029990379623292938> | Successfully hackbanned {userid} for {reason}",
                color=0x2f3136))
        except:
            await ctx.reply(embed=discord.Embed(
    ...
    async def give(
        ...
        if guild.me.top_role >= ctx.author.top_role:
            embed = discord.Embed(
                color=0x2f3136,
                description=
                "<a:error:1002226340516331571> | Your role is below the bot.")
            await ctx.send(embed=embed)
            return
        if member.top_role >= ctx.author.top_role:
            await ctx.send(
                "**<a:error:1002226340516331571> | The provided user has roles that are above or have the same role as you.**"
            )
            return
        else:
    ...
    async def _hideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<:GreenTick:1029990379623292938> | Hiding all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | Unhiding all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
    ...
    async def _hide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | Succefully Hidden {channel.mention} .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _unhide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | Succefully Unhidden {channel.mention} .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
...
Reason: `{entry.reason}`\n\n''')
    ...
    async def _softban(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | Sucessfully soft-banned {member}.",
            timestamp=ctx.message.created_at)
    ...
    async def purge(self, ctx, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:GreenTick:1029990379623292938> Deleted {len(deleted)-1} message(s)**"
        )
    ...
    async def startswith(self, ctx, key, amount: int = 10):
        ...
        return await ctx.send(
            f"**<:GreenTick:1029990379623292938> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**"
        )
    ...
    async def endswith(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:GreenTick:1029990379623292938> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**"
        )
    ...
    async def contains(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:GreenTick:1029990379623292938> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**"
        )
    ...
    async def user(self, ctx, user: discord.Member, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:GreenTick:1029990379623292938> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**"
        )
    ...
    async def invites(self, ctx, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<:GreenTick:1029990379623292938> Deleted {len(deleted)}/{amount} message(s) which contained invites**"
        )
        ...
        if tame == -1:
            ...
            if till.lower() == "d":
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:GreenTick:1029990379623292938> | Successfully Muted {0.mention} For {1} Day(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "m":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:GreenTick:1029990379623292938> | Successfully Muted {0.mention} For {1} Minute(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "s":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:GreenTick:1029990379623292938> | Successfully Muted {0.mention} For {1} Second(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "h":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:GreenTick:1029990379623292938> | Successfully Muted {0.mention} For {1} Hour(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
        try:
        ...
        if member.is_timed_out():
            try:
                ...
                hacker5 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:GreenTick:1029990379623292938> | Successfully Unmuted {member.name}",
                    timestamp=ctx.message.created_at)
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:error:1002226340516331571> | Unable to Remove Timeout:\n```py\n{}```"
                    .format(e),
                    timestamp=ctx.message.created_at)
                await ctx.send(embed=hacker)
        else:
            hacker1 = discord.Embed(
                color=0x2f3136,
                description="<a:error:1002226340516331571> | {} Is Not Muted".
    ...
    async def _kick(self,
        ...
        if ctx.author.top_role.position > member.top_role.position or member == ctx.guild.owner:
            ...
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:GreenTick:1029990379623292938> | {member.display_name} has been kicked from this guild, for: {reason}",
                timestamp=ctx.message.created_at)
        ...
        if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
            await ctx.send(
                "*<a:error:1002226340516331571> | You cannot kick someone with a higher role than you!*"
            )
    ...
    async def _warn(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | {member.display_name} has been warned for: {reason}",
            timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _ban(self,
        ...
        if ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
            ...
            hacker = discord.Embed(
                color=0x00FFE4,
                description=
                f"<:GreenTick:1029990379623292938> | {member.display_name} has been successfully banned for the reason: `{reason}`",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
        ...
        if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
            embed = discord.Embed(
                color=0x00FFE4,
                description=
                f"*<a:error:1002226340516331571> | You cannot ban someone with a higher role than you.*",
                timestamp=ctx.message.created_at)
            await ctx.send(embed=embed)
    ...
    async def _unban(self, ctx: commands.Context, id: int):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | {user.name} has been successfully unbanned",
            timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def changenickname(self, ctx: commands.Context,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<:GreenTick:1029990379623292938> | Successfully changed nickname of {member.name}",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _reactions(self, ctx, search=1000):
        ...
        await ctx.send(embed=discord.Embed(
            description=
            f"<:GreenTick:1029990379623292938> | Successfully Removed {total_reactions}.",
            color=0x2f3136))
    ...
    async def _lock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Krypton | Lockdown",
                description=
                "<:GreenTick:1018174649198202990> | Successfully locked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="Krypton | Lockdown",
    ...
    async def _unlock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Krypton | Unlockdown",
                description=
                "<:GreenTick:1018174649198202990> | Successfully unlocked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="Krypton | Unlockdown",
...
**Description:** {pack.description}
    ...
    async def remove(self, ctx, user: discord.Member, role: discord.Role):
        ...
        hacker = discord.Embed(
            description=
            f"<:GreenTick:1018174649198202990> | Successfully removed {role.mention} from {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
